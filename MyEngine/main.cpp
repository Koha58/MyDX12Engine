...
MeshData CreateCubeMeshData()
{
    ...
    // 立方体の 8 頂点（位置 + RGBA 色）
    meshData.Vertices = {
        {{-0.5f, 0.5f,-0.5f},{1,0,0,1}},  // 0: 赤
        {{ 0.5f, 0.5f,-0.5f},{0,1,0,1}},  // 1: 緑
        {{-0.5f,-0.5f,-0.5f},{0,0,1,1}},  // 2: 青
        {{ 0.5f,-0.5f,-0.5f},{1,1,0,1}},  // 3: 黄
        {{-0.5f, 0.5f, 0.5f},{0,1,1,1}},  // 4: シアン
        {{ 0.5f, 0.5f, 0.5f},{1,0,1,1}},  // 5: マゼンタ
        {{-0.5f,-0.5f, 0.5f},{0,0,0,1}},  // 6: 黒
        {{ 0.5f,-0.5f, 0.5f},{1,1,1,1}},  // 7: 白
    };

    // 立方体を 12 個の三角形で構成するためのインデックス
    meshData.Indices = {
        0,1,2, 1,3,2,   // -Z 面
        4,6,5, 5,6,7,   // +Z 面
        4,5,0, 5,1,0,   // +Y 面
